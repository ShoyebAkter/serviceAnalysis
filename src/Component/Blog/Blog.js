...
const Blog = () => {
    return (
      <div className="m-7">
        ...
        <div>
          <h1 className="font-bold text-lg flex justify-center mb-5 mt-5">
           Inline-block vs Inline elements
          </h1>
          <p>
          Inline-block: They consume the entire width available irrespective of their sufficiency.
           They always start in a new line and have top and bottom margins.
            It does not contain any other elements next to it.
            </p>
            <p className="text-justify text-xl">
            Inline-element: Inline elements occupy only enough width that is sufficient to it and allows
             other elements next to it which are inline. Inline elements don't start from a new line and
              don't have top and bottom margins as block elements have.
          </p>
        </div>
      </div>
    );
